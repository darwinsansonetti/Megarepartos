...
<!-- Mirrored from www.ansonika.com/fooyes/index-3.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 27 Feb 2025 22:52:42 GMT -->
<head>
    <meta charset="utf-8">
...
<body>
    ...
    <header class="header clearfix element_to_stick">
        <div class="container">
            <div id="logo">
                <a href="index.html">
                    <img src="{{ asset('img/logo.png') }}" width="162" height="35" alt="" class="logo_normal">
                    <img src="{{ asset('img/logo.png') }}" width="162" height="35" alt="" class="logo_sticky">
                </a>
            </div>
            ...
            <nav class="main-menu">
                <div id="header_menu">
                    ...
                    <a href="index.html"><img src="{{ asset('img/logo.png') }}" width="162" height="35" alt=""></a>
                </div>
                <ul>
                   <li class="submenu">
                ...
                <div class="container">
                    <div class="row justify-content-lg-start justify-content-md-center">
                        <div class="col-xl-7 col-lg-8">
                            ...
                            <form method="post" action="https://www.ansonika.com/fooyes/grid-listing-filterscol.html">
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6">
                    ...
                    <div class="collapse dont-collapse-sm links" id="collapse_1">
                        <ul>
                            <li><a href="https://ansonika.com/fooyes/about.html">About us</a></li>
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <div class="collapse dont-collapse-sm links" id="collapse_2">
                        <ul>
                            ...
                            <li><a href="https://ansonika.com/fooyes/grid-listing-filterscol-full-masonry.html">Best Rated</a></li>
                            <li><a href="https://ansonika.com/fooyes/grid-listing-filterscol-full-width.html">Best Price</a></li>
                            <li><a href="https://ansonika.com/fooyes/grid-listing-filterscol-full-masonry.html">Latest Submissions</a></li>
                        </ul>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6">
...
<!-- Mirrored from www.ansonika.com/fooyes/index-3.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 27 Feb 2025 22:52:43 GMT -->
</html>